...
ActiveRecord::Schema.define(version: 20180203020012) do
  ...
  create_table "periods", force: :cascade do |t|
    ...
    t.string "title"
    t.decimal "session_number", precision: 4, scale: 2
    t.index ["group_id"], name: "index_periods_on_group_id"
  end
